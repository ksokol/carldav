...
INSERT INTO item (collectionid, itemtype, id, etag, modifydate, displayname, itemname, uid, ownerid)
VALUES (1, 'cardcollection', 3, 'njy57RJot0LhdYELkMDJ9gQZiOM=', to_timestamp('2015-11-21 21:11:00','YYYY-MM-DD HH:MI:SS'), 'contactDisplayName', 'contacts', 'a112ed14-0106-4616-bb40-a416a8305464', 2);

INSERT INTO item (collectionid, itemtype, id, etag, modifydate, displayname, itemname, uid, ownerid)
VALUES (null, 'homecollection', 4, 'ghFexXxxU+9KC/of1jmJ82wMFig=', to_timestamp('2015-11-21 21:11:00','YYYY-MM-DD HH:MI:SS'), 'homeCollection', 'test02@localhost.de', 'de359448-1ee0-4151-872d-eea0ee462bc7', 3);
