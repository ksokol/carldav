...
class IosTests extends IntegrationTestSupport {
    ...
    void fetchCalendarFirstTime() {
        ...
        def response1 = """\
                            <D:multistatus xmlns:D="DAV:">
                              <D:response>
                                <D:href>/carldav/dav/test01@localhost.de/calendar/BC9458C9-C221-4E23-BA24-1E3D4EDBE65B.ics</D:href>
                                <D:propstat>
                                  <D:prop>
    ...
    void fetchAddressbookFirstTime() {
        ...
        def response1 = """\
                            <D:multistatus xmlns:D="DAV:">
                                <D:response>
                                    <D:href>/carldav/principals</D:href>
                                    <D:propstat>
                                        <D:prop>
        ...
        def request6 = """\
                        <B:addressbook-multiget xmlns:B="urn:ietf:params:xml:ns:carddav">
                          ...
                          <A:href xmlns:A="DAV:">/carldav/dav/test01@localhost.de/contacts/292BB88D-5C0D-4A1E-AB2B-BF878FCACB2F.vcf</A:href>
