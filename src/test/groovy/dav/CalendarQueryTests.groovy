...
class CalendarQueryTests extends IntegrationTestSupport {
    ...
    void limitRecurrenceSet() {
        ...
        def response3 = """\
                        <D:multistatus xmlns:D="DAV:">
                            <D:response>
                                <D:href>/carldav/dav/test01@localhost.de/calendar/20160123T135858Z-25739-1000-1796-13_localhost-20160123T135931Z.ics</D:href>
                                <D:propstat>
                                    <D:prop>
    ...
    ResultMatcher response(String calendarData, String etag, String uuid) {
        return xml("""\
                    <D:multistatus xmlns:D="DAV:">
                        <D:response>
                            <D:href>/carldav/dav/test01@localhost.de/calendar/${uuid}.ics</D:href>
                            <D:propstat>
                                <D:prop>
                            ...
                            <C:comp-filter name="VCALENDAR">
                              <C:comp-filter name="VEVENT">
                                <C:prop-filter name="UID">
                                  <C:text-match collation="i;ascii-casemap">e94d89d2-b195-4128-a9a8-be83a873deae</C:text-match>
                                </C:prop-filter>
                              </C:comp-filter>
                            </C:comp-filter>
                          </C:filter>
                        ...
                        <C:calendar-query xmlns:C="urn:ietf:params:xml:ns:caldav" xmlns:D="DAV:">
                          <C:filter>
                            <C:comp-filter name="VCALENDAR">
                              <C:comp-filter name="VEVENT">
                                <C:prop-filter name="UID">
                                    <C:text-match negate-condition="yes" collation="i;ascii-casemap">e94d89d2-b195-4128-a9a8-be83a873deae</C:text-match>
                                </C:prop-filter>
                              </C:comp-filter>
                            </C:comp-filter>
                          </C:filter>
                        ...
                        <C:calendar-query xmlns:C="urn:ietf:params:xml:ns:caldav" xmlns:D="DAV:">
                          <C:filter>
                            <C:comp-filter name="VCALENDAR">
                              <C:comp-filter name="VEVENT">
                                <C:prop-filter name="UID">
                                    <C:text-match>E94d89d2-b195-4128-a9a8-be83a873deae</C:text-match>
                                </C:prop-filter>
                              </C:comp-filter>
                            </C:comp-filter>
                          </C:filter>
                            ...
                            <C:comp-filter name="VCALENDAR">
                              <C:comp-filter name="VEVENT">
                                <C:prop-filter name="SUMMARY">
                                  <C:text-match collation="i;octet">add</C:text-match>
                                </C:prop-filter>
                              </C:comp-filter>
                            </C:comp-filter>
                          </C:filter>
                        ...
                        <C:calendar-query xmlns:C="urn:ietf:params:xml:ns:caldav" xmlns:D="DAV:">
                          <C:filter>
                            <C:comp-filter name="VCALENDAR">
                              <C:comp-filter name="VEVENT">
                                <C:prop-filter name="SUMMARY">
                                    <C:text-match collation="i;octet">add2</C:text-match>
                                </C:prop-filter>
                              </C:comp-filter>
                            </C:comp-filter>
                          </C:filter>
