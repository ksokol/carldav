...
public class CaldavOutputFilter implements DavConstants, CaldavConstants, ICalendarConstants {
    ...
    private static OutputFilter parseCalendarDataComp(Element comp) {
        ...
        String name =
                DomUtils.getAttribute(comp, ATTR_CALDAV_NAME);
        if (name == null) {
            return null;
        }
        ...
        while (i.hasNext()) {
            ...
            if (ELEMENT_CALDAV_ALLCOMP.equals(child.getLocalName())) {
                ...
                // Get required name attribute
                String propname =
                        DomUtils.getAttribute(child, ATTR_CALDAV_NAME);
                if (propname == null) {
                    result = null;
                    return null;
                }
                ...
                String novaluetxt =
                        DomUtils.getAttribute(child, ATTR_CALDAV_NOVALUE);
                if (novaluetxt != null) {
    ...
    private static Period parsePeriod(Element node) throws CosmoDavException {
        ...
        String end =
                DomUtils.getAttribute(node, ATTR_CALDAV_END);
        if (end == null) {
